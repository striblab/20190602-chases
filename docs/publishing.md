...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190608-chases">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190608-chases/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190608-chases/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190608-chases/",
      "url": "http://static.startribune.com/news/projects/all/20190608-chases/"
    }
  }
}
```
